...
function App() {
  ...
  const confirmBooking = async (tripId) => {
    try {
      const res = await axios.patch(`${API_URL}/trips/${tripId}/confirm`);
  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
        <div className="bg-white w-full max-w-md rounded-2xl shadow-sm border border-slate-200 p-6">
          <h1 className="text-2xl font-bold mb-2">AI Travel Agent</h1>
            ...
            <div className="space-y-4">
              ...
              {savedTrips.map((trip) => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-600">{trip.days} Days</p>
